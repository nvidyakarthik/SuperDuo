...
/**
 * Created by Vidya on 12/11/2015.
 */
    ...
    public RemoteViewsFactory onGetViewFactory(Intent intent) {
        return new RemoteViewsFactory() {
            ...
            public void onDataSetChanged() {
                ...
                cursor= getContentResolver().query(dateUri, SCORE_COLUMNS, DatabaseContract.PATH_DATE, date, null);
                //cursor = getContentResolver().query(DatabaseContract.BASE_CONTENT_URI,null,null ,null, null);
            ...
            public RemoteViews getViewAt(int position) {
                ...
                int homeGoal = cursor.getInt(COL_HOME_GOALS);
                int awayGoal = cursor.getInt(COL_AWAY_GOALS);
