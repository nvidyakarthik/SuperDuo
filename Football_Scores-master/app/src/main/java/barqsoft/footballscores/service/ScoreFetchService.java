...
public class ScoreFetchService extends IntentService {
    public static final String LOG_TAG = "ScoreFetchService";
    ...
    private void processJSONdata(String JSONdata, Context mContext, boolean isReal) {
        ...
        final String BUNDESLIGA1 = "357";//This league code is used to display dummy data when there is no match available
